...
export const register = async (req, res) => {
    ...
    const person_query = "INSERT INTO person (person_first_name, person_middle_initial, person_last_name, person_email, person_birthdate, person_hashed_password) VALUES (?, ?, ?, ?, ?, ?)";
